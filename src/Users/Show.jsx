        ...
        <div className={s.Container}>
            ...
            {props.users.map(u =>
                <div className={!u.video ? s.Small : s.Big}>
                        ...
                        <div className={s.content}>
                            <div className={s.header}>
                                ...
                                <span className={s.last}> {u.favourite == true ?
                                    <img src={FullStar} className={s.star} onClick={() => { props.isFollow(u.id) }} /> :
                                    <img className={s.star} src={Star} onClick={() => { props.isUnfollow(u.id) }} />}
                                </span>
                            </div>
                   ...
                   <video className={s.player} preload='none' controlsList='nodownload' controls src={boy}></video>
                  
                : 
                <video className={s.player} preload='none' controlsList='nodownload' controls src={shoe}></video>
                }</div>}
